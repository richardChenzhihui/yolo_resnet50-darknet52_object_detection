...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', default="./data/ass1_dataset/val/image/000001.jpg", help='Path to Image file')
    ...
    parser.add_argument('--nms_threshold', default=0.3, type=float, help='Threshold for non maximum suppression')
    ...
    image_root = "./data/ass1_dataset/val/image/"
